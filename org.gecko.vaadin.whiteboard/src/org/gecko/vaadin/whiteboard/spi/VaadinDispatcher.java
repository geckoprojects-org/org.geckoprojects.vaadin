...
/**
 * Dispatcher interface to handle arriving and removed Vaadin resources
...
public interface VaadinDispatcher {
	...
	/**
	 * Dispatch call to apply the changed services 
	 */
